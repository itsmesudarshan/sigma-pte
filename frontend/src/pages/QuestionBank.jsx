...
export default function QuestionBank() {
  ...
  useEffect(() => { load(); }, [q_type, difficulty, favoritesOnly]);
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 10, marginBottom: 20, flexWrap: 'wrap' }}>
        <div style={{ position: 'relative', flex: '1 1 240px' }}>
          ...
          <input
            ...
            style={{
              ...
              border: '1px solid var(--line-strong)', fontSize: 13, background: 'var(--paper-raised)',
            }}
          />
        </div>
        ...
        <select
          value={q_type}
          onChange={(e) => setSearchParams(e.target.value ? { q_type: e.target.value } : {})}
        ...
        {questions.map((q) => (
          <button
            ...
            style={{
              ...
              background: 'var(--paper-raised)', textAlign: 'left',
            }}
          >
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 4 }}>
                <span
                  className="mono"
                  style={{ fontSize: 11, fontWeight: 700, color: 'var(--focus)', background: 'var(--focus-soft)', padding: '2px 7px', borderRadius: 999 }}
                >
